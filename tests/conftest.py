...
SQLALCHEMY_DATABASE_URL = f"postgresql://{settings.database_username}:{settings.database_password}@postgres:{settings.database_port}/{settings.database_name}-test"
